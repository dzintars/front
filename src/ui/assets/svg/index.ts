...
export const Grid = (color: string): SVGTemplateResult => {
  ...
  return svg`
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
        <path class='primary' stroke=${params.primaryColor} stroke-width="16" stroke-linecap="round" d="M32 24h64"/>
        <path class='secondary' stroke=${params.primaryColor} stroke-width="16" stroke-linecap="round" d="M48 104h64M16 64h64M32 0"/>
    </svg>
`
}
